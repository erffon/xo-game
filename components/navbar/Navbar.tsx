  ...
  return (
    <nav className="container flex pt-8 items-center">
      <div className="flex flex-1 items-center gap-7">
        ...
        <p className="text-black font-bold leading-4 text-lg">
          Tic Tac Toe <br />
          (XO) game
        </p>
      </div>
      <div className="flex gap-8">
        <button className="flex-1 border border-primary-light px-5 py-1 rounded-lg text-texts-light hover:shadow-md">
          About
        </button>
