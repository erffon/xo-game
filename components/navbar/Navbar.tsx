...
function Navbar() {
  return (
    <nav className="container flex pt-10 items-center h-1/6">
      ...
      <div className="flex flex-1 gap-6 justify-end">
        ...
        {/* <button className="px-5 py-1 bg-secondary-light rounded-lg text-texts-light font-inter border border-borders hover:shadow-md">
          Reset
        </button> */}
